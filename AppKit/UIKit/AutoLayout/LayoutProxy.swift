...
//  PDAppKit
//
//  Created by roy.cao on 2019/3/15.
...
public protocol LayoutDimension {
    ...
    func constraint(greaterThanOrEqualTo anchor: Self, multiplier mul: CGFloat, constant float: CGFloat) -> NSLayoutConstraint
    func constraint(lessThanOrEqualTo anchor: Self, multiplier mul: CGFloat, constant float: CGFloat) -> NSLayoutConstraint
}
...
/// Constant + - operation in the presence of otherAnchor and multiplier
